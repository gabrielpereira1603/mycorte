...
<html lang="pt-BR">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/client/headerClient.css') }}">
        <link rel="stylesheet" href="{{ asset('css/client/homeClient.css') }}">
    ...
    <body>
    @include('Client.Header.headerClient', ['tokenCompany' => $tokenCompany])
    ...
    @include('Client.Footer.footerClient', ['tokenCompany' => $tokenCompany])
