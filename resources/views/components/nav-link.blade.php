...
$classes = ($active ?? false)
            ? 'inline-flex items-center cursor-pointer px-1 pt-1 border-b-2 border-red-400 dark:border-red-600 text-sm font-medium leading-5 text-red-200 focus:outline-none focus:border-red-700 transition duration-150 ease-in-out focus:text-red-700 dark:focus:text-red-700'
