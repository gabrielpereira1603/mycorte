...
<head>
    ...
    <title>Obrigado por Comparecer</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<div class="container">
    <div class="header">
        <img src="https://i.postimg.cc/RCDV18qy/temp-Imageh1yvji.avif" alt="Obrigado por Comparecer">
    </div>
    <div class="content">
        <h1>Obrigado, {{ $clientName }}!</h1>
        <p>Agradecemos por ter comparecido ao seu agendamento em {{ $companyName }}.</p>
