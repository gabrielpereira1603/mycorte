...
<head>
    ...
    <title>Lamentamos seu Cancelamento</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Infelizmente, recebemos a notificação do cancelamento do seu agendamento na <span>{{ $companyName }}</span>.</p>
        <p>Estamos tristes por não poder atendê-lo desta vez, mas entendemos que imprevistos acontecem.</p>
