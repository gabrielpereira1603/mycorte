            ...
            <div class="row gy-4 gy-lg-0 justify-content-xl-between">
                ...
                <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                    <div class="widget">
                        ...
                        <address class="mb-4" style="color: #6c757d;">Número 282 Rua Noruega, Santa Fé do Sul, São Paulo</address>
                        <p class="mb-1">
                        ...
                        <p class="mb-0">
                            <a class="link-secondary text-decoration-none" href="mailto:suporte@somosdevteam.com">suportesomosdevteam.com</a>
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3 col-xl-2">
            ...
            <div class="row gy-4 gy-md-0 align-items-md-center">
                <div class="col-xs-12 col-md-7 order-1 order-md-0">
                    ...
                    <div class="credits text-secondary text-center text-md-start mt-2 fs-8">
                        Desenvolvido por <a href="https://bootstrapbrain.com/" class="link-secondary text-decoration-none">Somos Dev's</a> <span class="text-primary">&#9829;</span>
                    </div>
                </div>
