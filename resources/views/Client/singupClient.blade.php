...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('images/apenasLogo.svg') }}">
    <link rel="stylesheet" href="{{ asset('css/client/singupClient.css') }}">
...
<main>
    <section class="form-section">
        <img src="{{ asset('images/logoLetraAzul.png') }}" alt="Logo" class="logo-login">
        <h2>Acesse sua conta</h2>
        <form id="singupForm" method="post" action="{{ route('singupclient.post', ['tokenCompany' => $tokenCompany]) }}">
            @csrf
            ...
            <div class="input-wrapper">
                ...
                <div class="input-content">
                    ...
                    <div class="icon">
                        <img src="{{ asset('images/icons/iconName.svg') }}" alt="Name Icon">
                    </div>
                </div>
            </div>
            ...
            <div class="input-wrapper">
                ...
                <div class="input-content">
                    <input type="email" id="email" placeholder="jhon@email.com" name="email" required>
                    <div class="icon">
            ...
            <div class="input-wrapper">
                ...
                <div class="input-content">
                    <input type="text" id="telefone" placeholder="(00) 00000-0000" name="telephone" required>
                    <div class="icon">
                        <img src="{{ asset('images/icons/iconTelephone.svg') }}" alt="Telephone Icon">
                    </div>
                </div>
            </div>
            ...
            <div class="btn-wrapper">
                <button class="button btn-primary" type="submit" id="singupBtn" onclick="handleSubmit('singupBtn', 'singupForm')">
                    Cadastre-se Agora
                </button>
                <div class="divider">
                    <div></div>
                ...
                <a class="button btn-secondary" href="{{ route('loginclient', ['tokenCompany' => $tokenCompany]) }}" id="loginBtn" onclick="handleLink('loginBtn')">
                    Entrar Agora
                </a>
            </div>
        </form>
